...
def rand_palavra():
     ...
     palavras = ["maca", "banana", "laranja", "uva", "morango", "abacaxi", "manga", "pera", "melancia", "limao", "cereja", "pessego", "kiwi", "ameixa", "coco", "amora", "maracuja", "caju"]
...
def main():
     ...
     if game.hangman_won():
         print('\nParabéns! Você adivinhou a palavra e venceu!!!')
     else:
         print('\nGame Over! Você não adivinhou a palavra e perdeu!!!')
         print('A palavra correta era ' + game.palavra)

     print('\nFoi bom jogar com você! Agora é hora de estudar!!!')
